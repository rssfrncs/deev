        ...
        {({ close }) => (
          <form onSubmit={(e) => handleSubmit(e, close)} className="flex flex-col gap-3">
            ...
            <button
              type="submit"
              disabled={creating}
              className="rounded-pill bg-veed-green hover:bg-veed-green-hover text-ink font-medium text-sm px-5 py-2.5 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
